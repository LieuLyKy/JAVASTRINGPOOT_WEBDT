...
import com.example.WebDT.models.CartItem;
import com.example.WebDT.repository.UserRepository;
import com.example.WebDT.services.CartService;
...
public class CartController {
    ...
    public String Order() {
        ...
        com.example.WebDT.entity.User findUser = userRepo.getUserByUsernameOrEmail(user.getUsername());
